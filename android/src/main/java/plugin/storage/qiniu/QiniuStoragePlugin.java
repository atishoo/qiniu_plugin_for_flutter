...
public class QiniuStoragePlugin implements MethodCallHandler,EventChannel.StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    QiniuStoragePlugin plugin = new QiniuStoragePlugin(registrar);
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "qiniu_plugin");
    channel.setMethodCallHandler(plugin);
    EventChannel eventChannel = new EventChannel(registrar.messenger(), "qiniu_plugin_event");
    eventChannel.setStreamHandler(plugin);
  }

  private QiniuStoragePlugin(Registrar registrar){
  ...
  private void upload(final MethodCall call,final Result result){
    ...
    UpCompletionHandler upCompletionHandler = new UpCompletionHandler() {
      ...
      public void complete(String key, final ResponseInfo info, final JSONObject res) {
        ...
        resultData.put("result", info.isOK()?1:0);
